This repo contains tutorial notebooks on how to use GeoJikuu to perform various GIS analyses. The current version contains two tutorials in the form of Jupyter notebooks:
